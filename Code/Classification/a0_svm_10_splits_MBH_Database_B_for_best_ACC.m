...
function [res] = a0_svm_10_splits_MBH_Database_B_for_best_ACC(hist_dir, fold_idx, descriptor_type,descriptor_folder,model_type,database,use_hist_pca,folds_type)
%close all
%clear all
