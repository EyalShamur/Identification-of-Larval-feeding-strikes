...
function [res] = a0_svm_10_splits_MIP_Database_B_per_fold(descriptor_type,descriptor_folder,model_type,database,use_hist_pca,folds_type,i_tries)
...
for fold_idx=1:n_folds
    ...
    if use_hist_pca
        mip_histogram_dir = sprintf('H:\\thesis - eating fishes\\DATABASES\\Database-%s\\%s\\%s\\PCA_HIST_SQRT_ALL',database,model_type,descriptor_folder);
        ...
        mip_histogram_dir = sprintf('H:\\thesis - eating fishes\\DATABASES\\Database-%s\\%s\\%s\\HISTOGRAM_1024',database,model_type,descriptor_folder);
