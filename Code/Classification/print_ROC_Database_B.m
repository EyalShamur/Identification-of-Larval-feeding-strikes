    ...
    % STIP
    descriptor_folder='STIP_thresh=0_szf=20';
    run_id=2088;
    i_tries=1;
    ...
    % MIP
    descriptor_folder='MIP_N12_M12_gap1_T_GL8';
    run_id=2089;
    i_tries=1;
    ...
    descriptor_folder='MBH_patch_size=64';
    run_id=2087;
    i_tries=2;
    input_dir = sprintf('H:\\thesis - eating fishes\\DATABASES\\Database-%s\\%s\\%s\\RUN_ID_%d\\SVM\\test_num_%d\\AUC_params.mat',database,model_type,descriptor_folder,run_id,i_tries);
    load (input_dir, 'testing_label_vector_all', 'testing_decision_values_all' );
    ...
    % VIF
    descriptor_folder='VIF_M=N=3_S=17_T=1.0_H=21_per_cell';
    run_id=2100;
    i_tries=6;
    input_dir = sprintf('H:\\thesis - eating fishes\\DATABASES\\Database-%s\\%s\\%s\\RUN_ID_%d\\SVM\\test_num_%d\\AUC_params.mat',database,model_type,descriptor_folder,run_id,i_tries);
    load (input_dir, 'testing_label_vector_all', 'testing_decision_values_all' );
