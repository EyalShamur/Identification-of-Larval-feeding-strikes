...
A_query_2_symetric = 0;
A_query_2_all_weightedSVM = 1;
A_query_2_partialy_weightedSVM = 0;

B_query_409 = 0;
B_query_562 = 0;

B_query_562_1_all_symetricSVM = 0;
B_query_562_1_all_wheightedSVM = 0;

B_query_562_2_all_symetricSVM = 0;
B_query_562_2_all_wheightedSVM = 0;

B_query_202_all_symetricSVM = 0;
B_query_202_all_wheightedSVM = 0;
...
if A
   ...
   desc_folders = {...
    ...
    %}
    desc_folders = {...
        'MBH_patch_size=32\\RUN_ID_1140\\SVM\\test_num_1';...
        %'MIP_N12_M12_gap1_T_GL8\\run_id_1023\\SVM_PCA\\test_num_1';...
        'MIP_orig\\run_id_1141\\SVM_PCA\\test_num_1';...
        %'VIF_M=N=3_S=7_T=1.5_H=21_perCell\\RUN_ID_1019\\SVM\\test_num_1';...
        %'VIF_M=N=3_S=7_T=1.5_H=21\\RUN_ID_1020\\SVM\\test_num_1';...
        'VIF_M=N=3_S=1_T=1.0_H=21\\run_id_1143\\SVM\\test_num_1';...
        %'VIF_orig\\SVM\\test_num_1';...
        'STIP_thresh=0_kparam=0.005_szf=20\\RUN_ID_1142\\SVM\\test_num_1';...
    };
...
if A_query_2_symetric
    ...
    desc_folders = {...
        'MBH_patch_size=32\\RUN_ID_1123\\SVM\\test_num_1';...
        %'MIP_N12_M12_gap1_T_GL8\\run_id_1023\\SVM_PCA\\test_num_1';...
        'MIP_orig\\run_id_1127\\SVM_PCA\\test_num_1';...
        %'VIF_M=N=3_S=7_T=1.5_H=21_perCell\\RUN_ID_1019\\SVM\\test_num_1';...
        %'VIF_M=N=3_S=7_T=1.5_H=21\\RUN_ID_1020\\SVM\\test_num_1';...
        'VIF_M=N=3_S=1_T=1.0_H=21\\run_id_1122\\SVM\\test_num_1';...
        %'VIF_orig\\SVM\\test_num_1';...
        'STIP_thresh=0_kparam=0.005_szf=20\\RUN_ID_1121\\SVM\\test_num_1';...
    };
end

if A_query_2_all_weightedSVM
    folds_type = 'Database_A_no_avi2_6x40_folds';%
    db = 'A';
    ...
    desc_folders = {...
        'MBH_patch_size=32\\RUN_ID_1163\\SVM\\test_num_1';...
        %'MIP_N12_M12_gap1_T_GL8\\run_id_1023\\SVM_PCA\\test_num_1';...
        'MIP_orig\\run_id_1146\\SVM_PCA\\test_num_1';...
        %'VIF_M=N=3_S=7_T=1.5_H=21_perCell\\RUN_ID_1019\\SVM\\test_num_1';...
        %'VIF_M=N=3_S=7_T=1.5_H=21\\RUN_ID_1020\\SVM\\test_num_1';...
        'VIF_M=N=3_S=1_T=1.0_H=21\\run_id_1148\\SVM\\test_num_1';...
        %'VIF_orig\\SVM\\test_num_1';...
        'STIP_thresh=0_kparam=0.005_szf=20\\RUN_ID_1147\\SVM\\test_num_1';...
    };
end

if A_query_2_partialy_weightedSVM
    folds_type = 'Database_A_no_avi2_6x40_folds';%
    db = 'A';
    ...
    desc_folders = {...
        'MBH_patch_size=32\\RUN_ID_1145\\SVM\\test_num_1';...
        %'MIP_N12_M12_gap1_T_GL8\\run_id_1023\\SVM_PCA\\test_num_1';...
        'MIP_orig\\run_id_1146\\SVM_PCA\\test_num_1';...
        %'VIF_M=N=3_S=7_T=1.5_H=21_perCell\\RUN_ID_1019\\SVM\\test_num_1';...
        %'VIF_M=N=3_S=7_T=1.5_H=21\\RUN_ID_1020\\SVM\\test_num_1';...
...
if B 
    ...
    model_type = 'Models_300_HI_RES_rot_flip_corrected'; 
  %{  
    desc_folders = {...
        'MBH_patch_size=64\\RUN_ID_2087\\SVM\\test_num_2';...
        %'MIP_N12_M12_gap1_T_GL8\\run_id_1023\\SVM_PCA\\test_num_1';...
        'MIP_N12_M12_gap1_T_GL8\\run_id_2089\\SVM_PCA\\test_num_1';...
        %'VIF_M=N=3_S=7_T=1.5_H=21_perCell\\RUN_ID_1019\\SVM\\test_num_1';...
        %'VIF_M=N=3_S=7_T=1.5_H=21\\RUN_ID_1020\\SVM\\test_num_1';...
        'VIF_M=N=3_S=17_T=1.0_H=21_per_cell\\run_id_2100\\SVM\\test_num_2';...
        %'VIF_orig\\SVM\\test_num_1';...
        'STIP_thresh=0_szf=20\\RUN_ID_2088\\SVM\\test_num_3';...
    };
...
%}
    desc_folders = {...
        'MBH_patch_size=64\\RUN_ID_2087\\SVM\\test_num_2';...
        %'MIP_N12_M12_gap1_T_GL8\\run_id_1023\\SVM_PCA\\test_num_1';...
        'MIP_N12_M12_gap1_T_GL8\\run_id_2109\\SVM_PCA\\test_num_1';...
        %'VIF_M=N=3_S=7_T=1.5_H=21_perCell\\RUN_ID_1019\\SVM\\test_num_1';...
        %'VIF_M=N=3_S=7_T=1.5_H=21\\RUN_ID_1020\\SVM\\test_num_1';...
        'VIF_M=N=3_S=17_T=1.0_H=21_per_cell\\run_id_2100\\SVM\\test_num_6';...
        %'VIF_orig\\SVM\\test_num_1';...
        'STIP_thresh=0_szf=20\\RUN_ID_2088\\SVM\\test_num_1';...
    };
end


if B_query_409
    folds_type = 'Database_B_no_409_6x45_folds';%'Database_B_no_202_6x48_folds';
    db = 'B';

    model_type = 'Models_300_HI_RES_rot_flip_corrected'; 

    desc_folders = {...
        'MBH_patch_size=64\\RUN_ID_2121\\SVM\\test_num_1';...
        %'MIP_N12_M12_gap1_T_GL8\\run_id_1023\\SVM_PCA\\test_num_1';...
        'MIP_N12_M12_gap1_T_GL8\\run_id_2122\\SVM_PCA\\test_num_1';...
        %'VIF_M=N=3_S=7_T=1.5_H=21_perCell\\RUN_ID_1019\\SVM\\test_num_1';...
        %'VIF_M=N=3_S=7_T=1.5_H=21\\RUN_ID_1020\\SVM\\test_num_1';...
        'VIF_M=N=3_S=17_T=1.0_H=21_per_cell\\run_id_2117\\SVM\\test_num_1';...
        %'VIF_orig\\SVM\\test_num_1';...
        'STIP_thresh=0_szf=20\\RUN_ID_2113\\SVM\\test_num_1';...
    };
end
if B_query_562_1_all_wheightedSVM
    folds_type = 'Database_B_no_562-1_6x48_folds';%
    db = 'B';

    model_type = 'Models_300_HI_RES_rot_flip_corrected'; 

    desc_folders = {...
        'MBH_patch_size=64\\RUN_ID_2301\\SVM\\test_num_1';...
        %'MIP_N12_M12_gap1_T_GL8\\run_id_1023\\SVM_PCA\\test_num_1';...
        'MIP_N12_M12_gap1_T_GL8\\run_id_2298\\SVM_PCA\\test_num_1';...
        %'VIF_M=N=3_S=7_T=1.5_H=21_perCell\\RUN_ID_1019\\SVM\\test_num_1';...
        %'VIF_M=N=3_S=7_T=1.5_H=21\\RUN_ID_1020\\SVM\\test_num_1';...
        'VIF_M=N=3_S=7_T=1.5_H=21\\run_id_2300\\SVM\\test_num_1';...
        %'VIF_orig\\SVM\\test_num_1';...
        'STIP_thresh=0_szf=10\\RUN_ID_2299\\SVM\\test_num_1';...
    };
end
...
if B_query_562_1_all_symetricSVM
        folds_type = 'Database_B_no_562-1_6x48_folds';%
    db = 'B';
    ...
    desc_folders = {...
        'MBH_patch_size=64\\RUN_ID_2126\\SVM\\test_num_1';...
        %'MIP_N12_M12_gap1_T_GL8\\run_id_1023\\SVM_PCA\\test_num_1';...
        'MIP_N12_M12_gap1_T_GL8\\run_id_2246\\SVM_PCA\\test_num_1';...
        %'VIF_M=N=3_S=7_T=1.5_H=21_perCell\\RUN_ID_1019\\SVM\\test_num_1';...
        %'VIF_M=N=3_S=7_T=1.5_H=21\\RUN_ID_1020\\SVM\\test_num_1';...
        'VIF_M=N=3_S=7_T=1.5_H=21\\run_id_2263\\SVM\\test_num_1';...
        %'VIF_orig\\SVM\\test_num_1';...
        'STIP_thresh=0_szf=20\\RUN_ID_2259\\SVM\\test_num_1';...
    }; 
end

if B_query_562_2_all_wheightedSVM
    folds_type = 'Database_B_no_562-2_6x48_folds';%
    db = 'B';

    model_type = 'Models_300_HI_RES_rot_flip_corrected'; 

    desc_folders = {...
        'MBH_patch_size=64\\RUN_ID_2282\\SVM\\test_num_1';...
        %'MIP_N12_M12_gap1_T_GL8\\run_id_1023\\SVM_PCA\\test_num_1';...
        'MIP_N12_M12_gap1_T_GL8\\run_id_2286\\SVM_PCA\\test_num_1';...
        %'VIF_M=N=3_S=7_T=1.5_H=21_perCell\\RUN_ID_1019\\SVM\\test_num_1';...
        %'VIF_M=N=3_S=7_T=1.5_H=21\\RUN_ID_1020\\SVM\\test_num_1';...
        'VIF_M=N=3_S=7_T=1.5_H=21\\run_id_2290\\SVM\\test_num_1';...
        %'VIF_orig\\SVM\\test_num_1';...
        'STIP_thresh=0_szf=10\\RUN_ID_2287\\SVM\\test_num_1';...
    };
end
...
if B_query_562_2_all_symetricSVM
    folds_type = 'Database_B_no_562-2_6x48_folds';%
    db = 'B';
    ...
    desc_folders = {...
        'MBH_patch_size=64\\RUN_ID_2207\\SVM\\test_num_1';...
        %'MIP_N12_M12_gap1_T_GL8\\run_id_1023\\SVM_PCA\\test_num_1';...
        'MIP_N12_M12_gap1_T_GL8\\run_id_2248\\SVM_PCA\\test_num_1';...
        %'VIF_M=N=3_S=7_T=1.5_H=21_perCell\\RUN_ID_1019\\SVM\\test_num_1';...
        %'VIF_M=N=3_S=7_T=1.5_H=21\\RUN_ID_1020\\SVM\\test_num_1';...
        'VIF_M=N=3_S=7_T=1.5_H=21\\run_id_2253\\SVM\\test_num_1';...
        %'VIF_orig\\SVM\\test_num_1';...
        'STIP_thresh=0_szf=10\\RUN_ID_2250\\SVM\\test_num_1';...
    };
end


if B_query_202_all_wheightedSVM
    folds_type = 'Database_B_no_202_6x48_folds';%
    db = 'B';

    model_type = 'Models_300_HI_RES_rot_flip_corrected'; 

    desc_folders = {...
        'MBH_patch_size=64\\RUN_ID_2220\\SVM\\test_num_1';...
        %'MIP_N12_M12_gap1_T_GL8\\run_id_1023\\SVM_PCA\\test_num_1';...
        'MIP_N12_M12_gap1_T_GL8\\run_id_2292\\SVM_PCA\\test_num_1';...
        %'VIF_M=N=3_S=7_T=1.5_H=21_perCell\\RUN_ID_1019\\SVM\\test_num_1';...
        %'VIF_M=N=3_S=7_T=1.5_H=21\\RUN_ID_1020\\SVM\\test_num_1';...
        'VIF_M=N=3_S=7_T=1.5_H=21\\run_id_2293\\SVM\\test_num_1';...
        %'VIF_orig\\SVM\\test_num_1';...
        'STIP_thresh=0_szf=10\\RUN_ID_2294\\SVM\\test_num_1';...
    };
end



if B_query_202_all_symetricSVM
    folds_type = 'Database_B_no_202_6x48_folds';%
    db = 'B';
    ...
    desc_folders = {...
        'MBH_patch_size=64\\RUN_ID_2219\\SVM\\test_num_1';...
        %'MIP_N12_M12_gap1_T_GL8\\run_id_1023\\SVM_PCA\\test_num_1';...
        'MIP_N12_M12_gap1_T_GL8\\run_id_2222\\SVM_PCA\\test_num_1';...
        %'VIF_M=N=3_S=7_T=1.5_H=21_perCell\\RUN_ID_1019\\SVM\\test_num_1';...
        %'VIF_M=N=3_S=7_T=1.5_H=21\\RUN_ID_1020\\SVM\\test_num_1';...
        'VIF_M=N=3_S=7_T=1.5_H=21\\run_id_2231\\SVM\\test_num_1';...
        %'VIF_orig\\SVM\\test_num_1';...
        'STIP_thresh=0_szf=10\\RUN_ID_2235\\SVM\\test_num_1';...
    };
end
...
output_dir = sprintf('H:\\thesis - eating fishes\\DATABASES\\Database-%s\\%s\\STACKING\\RUN_ID_%d\\SVM\\%s',db,model_type,run_id,stack_option);
...
svm_kernel_type = ' -s 0 -t 0 -w1 0.005  -c 1 ';
clear fold_clips
clear fold_tags
...
for fold_idx=1:n_folds
    model_dir = sprintf('%s\\fold_%d',output_dir,fold_idx);
    if ~my_create_dir(model_dir); return; end;
